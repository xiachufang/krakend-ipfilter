...
```shell
go run main.go -c deny.json -d
```


deny from `127.0.0.1/8`


```shell
$ curl -i localhost:8989/api/get-user/x1ah -H 'X-Forwarded-For: 127.0.1.2'
...
```shell
$ curl -i localhost:8989/api/get-user/x1ah -H 'X-Forwarded-For: 117.2.1.2'
HTTP/1.1 200 OK
